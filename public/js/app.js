...
// i have Defined question object
...
Question.prototype.isCorrect = function (guess) {
  if (guess === this.correct) return true;
};

var QuizUI = {
  displayNext: function () {
    if (quiz.hasEnded()) this.displayScore();
    else {
  ...
  displayProgress: function () {
    ...
    this.setText(
      "progress",
      "Question " + (questionNo + 1) + " of " + quiz.questions.length
    );
  },
...
var question1 = new Question("What is 4+3 ?", ["10", "7"], 1);
...
var question5 = new Question(
  "Sui gas transfered from Province??",
  ["Punjab", "Balochistan"],
  1
);

var quiz = new Quiz([question1, question2, question3, question4, question5]);
QuizUI.displayNext();
